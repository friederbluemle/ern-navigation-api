...
final class EnNavigationRequests implements EnNavigationApi.Requests {
    ...
    @Override
    public RequestHandlerHandle registerBackRequestHandler(
    ...
    @Override
    public RequestHandlerHandle registerFinishRequestHandler(
    ...
    @Override
    public RequestHandlerHandle registerUpdateRequestHandler(
            @NonNull final ElectrodeBridgeRequestHandler<ErnNavRoute, None> handler) {
